...
public class ServletCadastrarProfessor extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (type.equalsIgnoreCase("cadastrarProfessor")){
            
                user = new Usuario(nome, cpf, endereco, email, telefone, senha, perfil);
                dao.cadastrarUsuario(user);
                
                redirect(resp, "pages/diretor/cadastrarProfessor", "Professor cadastrado com sucesso!");
                 
            }  else {
                redirect(resp, "pages/diretor/cadastrarProfessor", "Não foi possível cadastrar o professor!");
            }
        } catch (Exception ex) {
            System.out.println("ERRO NO SERVLET DE CADASTRO PROFESSOR" + ex);
        }
