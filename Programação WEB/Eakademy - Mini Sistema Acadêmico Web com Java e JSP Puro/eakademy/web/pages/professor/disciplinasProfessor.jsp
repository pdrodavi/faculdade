<%@page import="br.com.rokobasi.eakademy.model.Disciplinas_Professor"%>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Selecione a disciplina que você deseja lançar a nota
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <%
                                                ArrayList<Disciplinas_Professor> disciplinas_professor = (ArrayList<Disciplinas_Professor>) request.getAttribute("disciplinasDoProfessor");
                                            %>

                                            <form role="form" name="cadNotas" action="./cadNotas" method="post">     

                                                <div class="form-group">
                                                    <label>Disciplinas</label>
                                                    <select name="disciplina" class="form-control">
                                                        <%for(Disciplinas_Professor disciplina : disciplinas_professor){%>    
                                                            <option value=<%=disciplina.getId_disciplina()%>><%=disciplina.getNomeDisciplina()%></option>
                                                        <%}%>    
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <input type="hidden" value="visualizarAlunosPorDisciplina" name="param"/>
