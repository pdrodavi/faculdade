...
<html lang="pt-BR">
    <head>
        ...
        <title>Vincular Disciplina ao Professor</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">VINCULAR DISCIPLINA AO PROFESSOR</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Selecione o professor e a disciplina para criar um vinculo
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <%
                                                ...
                                                List<Usuario> usuarios = daoUsuarios.getProfessores();
                                            %>
                                            ...
                                            <form role="form" name="vincDisciplinaProfessor" action="../../vincDisciplinaProfessor" method="post">
                                                ...
                                                <div class="form-group">
                                                    <input type="hidden" value="vincularDisciplinaAoProfessor" name="param"/>
