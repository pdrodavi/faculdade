...
<html lang="pt-BR">
    <head>
        ...
        <title>Visualizar Alunos por Turma</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">VISUALIZAR ALUNOS DE TURMA</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Selecione a turma que deseja visualizar os alunos
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="visAlunosTurma" action="./visAlunosTurma" method="post">     

                                                <div class="form-group">
                                                    <label>Turmas</label>
                                                    <select name="turma" class="form-control">
                                                        <%for(Turmas_Curso turma_curso : turmas_curso){%>    
                                                            <option value=<%=turma_curso.getId()%>><%=turma_curso.getSigla()%> <%=turma_curso.getPeriodo()%></option>
                                                        <%}%>    
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <input type="hidden" value="visualizarAlunosDeTurma" name="param"/>
