...
<html lang="pt-BR">
    <head>
        ...
        <title>Vincular Professor a Turma</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">VINCULAR PROFESSOR A TURMA</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Selecione o professor para vincular a uma turma
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="vincProfessorTurma" action="../../vincProfessorTurma" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="turma" class="form-control">
                                                        <%for(Turma turma : turmas){%>    
                                                            <option value=<%=turma.getId()%>><%=turma.getSigla()%> <%=turma.getPeriodo()%></option>
                                                        <%}%>    
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <input type="hidden" value="vincularProfessorATurma" name="param"/>
