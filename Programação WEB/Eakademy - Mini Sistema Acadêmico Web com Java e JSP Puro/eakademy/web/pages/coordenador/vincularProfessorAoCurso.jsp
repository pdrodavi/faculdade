...
<html lang="pt-BR">
    <head>
        ...
        <title>Vincular Professor ao Curso</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">VINCULAR PROFESSOR AO CURSO</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Selecione o professor para vincular ao curso
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="vincProfessorCurso" action="../../vincProfessorCurso" method="post">
                                                ...
                                                <!-- PASSAR O ID DO CURSO DE MODO OCULTO -->
                                                <input type="hidden" value="${login.curso}" name="id_curso"/>

                                                <div class="form-group">
                                                    <input type="hidden" value="vincularProfessorAoCurso" name="param"/>
