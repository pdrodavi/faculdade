<%@page import="br.com.rokobasi.eakademy.model.Vestibular"%>
<%@page import="br.com.rokobasi.eakademy.dao.VestibularDAO"%>
...
<html lang="pt-BR">
    <head>
        ...
        <title>Lista de Vestibulares</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Vestibulares</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <%
                                                ...
                                                List<Vestibular> vests = dao.getAll();
                                            %>
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <%for (Vestibular vestibular : vests) {%>
                                                <tr>
                                                    <td><%=vestibular.getId()%></td>
                                                    <td><%=vestibular.getNome()%></td>
                                                    <td><%=vestibular.getData()%></td>
                                                    <td><a  href="editarVestibular.jsp?id=<%=vestibular.getId()%>"><img style="width: 20px;" src="../../res/img/editar.svg"/></a></td>
                                                    <td><a  href="javascript://" onclick="excluirVest(<%=vestibular.getId()%>, '<%=vestibular.getNome()%>')"><img style="width: 20px;" src="../../res/img/excluir.svg"/></a></td>
                                                </tr>
                                                <%}%>
                                            </table>
