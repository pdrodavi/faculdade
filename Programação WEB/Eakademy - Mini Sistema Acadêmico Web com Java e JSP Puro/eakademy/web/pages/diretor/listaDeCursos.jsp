                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=curso.getNome()%></td>
                                                    <td><%=curso.getArea()%></td>
                                                    <td><a  href="editarCurso.jsp?id=<%=curso.getId()%>"><img style="width: 20px;" src="../../res/img/editar.svg"/></a></td>
                                                    <td><a  href="javascript://" onclick="excluirCurso(<%=curso.getId()%>, '<%=curso.getNome()%>')"><img style="width: 20px;" src="../../res/img/excluir.svg"/></a></td>
                                                </tr>
                                                <%}%>
                                            </table>
