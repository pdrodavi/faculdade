    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%
                ...
                Vestibular vestibular = dao.getVestibularById(id);
            %>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">EDITAR VESTIBULAR</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="editVestibular" action="../../editVestibular" method="post">

                                                <div class="form-group">
                                                    <label>Nome</label>
                                                    <input type="text" name="nome" class="form-control" placeholder="Nome do Curso" value="<%=vestibular.getNome()%>">
                                                </div>

                                                <div class="form-group">
                                                    <label>Área</label>
                                                    <input type="text" name="data" class="form-control" placeholder="00/00/0000" value="<%=vestibular.getData()%>" onKeydown="mascaraData(this);">
                                                </div>
                                                
                                                <div class="form-group">
                                                    <input type="hidden" value="editarVestibular" name="param"/>
                                                    <input type="hidden" value="<%=vestibular.getId()%>" name="id"/>
