        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">EDITAR COORDENADOR</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="editCoordenador" action="../../editCoordenador" method="post">
                                                ...
                                                <div class="form-group">
                                                    <input type="hidden" value="editarCoordenador" name="param"/>
