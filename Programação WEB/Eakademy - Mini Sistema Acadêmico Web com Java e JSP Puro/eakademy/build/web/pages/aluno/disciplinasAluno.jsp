                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <%
                                                ArrayList<Disciplinas_Aluno> disciplinas_Aluno = (ArrayList<Disciplinas_Aluno>) request.getAttribute("disciplinasDoAluno");
                                            %>

                                            <form role="form" name="visAlunosTurma" action="./visNotasAlunoDisciplina" method="post">     

                                                <div class="form-group">
                                                    <label>Turmas</label>
                                                    <select name="disciplina" class="form-control">
                                                        <%for(Disciplinas_Aluno disciplina : disciplinas_Aluno){%>    
                                                            <option value=<%=disciplina.getId()%>><%=disciplina.getNomeDisciplina()%></option>
                                                        <%}%>    
                                                    </select>
                                                </div>

                                                <input type="hidden" value="${login.id}" name="id_aluno"/>
                                                    
                                                <div class="form-group">
                                                    <input type="hidden" value="visualizarNotas" name="param"/>
                                                    <button type="submit" class="btn btn-success">Ver Notas</button>
