        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">CADASTRAR VESTIBULAR</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="cadVest" action="../../cadVest" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>Área</label>
                                                    <input type="text" name="data" class="form-control" placeholder="00/00/0000" onKeyUp="mascaraData(this);">
                                                </div>

                                                <div class="form-group">
                                                    <input type="hidden" value="cadastrarVestibular" name="param"/>
