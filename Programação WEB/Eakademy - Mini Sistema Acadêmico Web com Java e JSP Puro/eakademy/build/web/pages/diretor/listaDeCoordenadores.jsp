        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Coordenadores</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <%
                                                ...
                                                List<Usuario> usuarios = dao.getCoordenadores();
                                            %>
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a  href="editarCoordenador.jsp?id=<%=usuario.getId()%>"><img style="width: 20px;" src="../../res/img/editar.svg"/></a></td>
                                                    <td><a  href="javascript://" onclick="excluirCoordenador(<%=usuario.getId()%>, '<%=usuario.getNome()%>')"><img style="width: 20px;" src="../../res/img/excluir.svg"/></a></td>
                                                </tr>
                                                <%}%>
                                            </table>
