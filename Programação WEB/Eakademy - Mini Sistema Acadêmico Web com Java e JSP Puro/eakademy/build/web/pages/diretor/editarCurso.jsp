    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%
                ...
                Curso curso = dao.getCursoById(id);
            %>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="editCurso" action="../../editCurso" method="post">

                                                <div class="form-group">
                                                    <label>Nome</label>
                                                    <input type="text" name="nome" class="form-control" placeholder="Nome do Curso" value="<%=curso.getNome()%>">
                                                </div>


                                                <div class="form-group">
                                                    <label>Área</label>
                                                    <input type="text" name="area" class="form-control" placeholder="Área do Curso" value="<%=curso.getArea()%>">
                                                </div>

                                                
                                                <div class="form-group">
                                                    <input type="hidden" value="editarCurso" name="param"/>
