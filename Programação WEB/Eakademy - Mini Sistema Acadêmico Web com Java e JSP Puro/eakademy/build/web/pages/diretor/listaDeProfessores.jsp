                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <%
                                                ...
                                                List<Usuario> usuarios = dao.getProfessores();
                                            %>
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a  href="editarProfessor.jsp?id=<%=usuario.getId()%>"><img style="width: 20px;" src="../../res/img/editar.svg"/></a></td>
                                                    <td><a  href="javascript://" onclick="excluirProfessor(<%=usuario.getId()%>, '<%=usuario.getNome()%>')"><img style="width: 20px;" src="../../res/img/excluir.svg"/></a></td>
                                                </tr>
                                                <%}%>
                                            </table>
