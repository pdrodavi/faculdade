                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form role="form" name="cadCurso" action="../../cadCurso" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>Área</label>
                                                    <input type="text" name="area" class="form-control" placeholder="Área do Curso">
                                                </div>

                                                
                                                <div class="form-group">
                                                    <input type="hidden" value="cadastrarCurso" name="param"/>
