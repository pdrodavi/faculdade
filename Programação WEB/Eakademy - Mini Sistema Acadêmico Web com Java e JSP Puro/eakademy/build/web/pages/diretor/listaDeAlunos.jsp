                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a  href="editarAluno.jsp?id=<%=usuario.getId()%>"><img style="width: 20px;" src="../../res/img/editar.svg"/></a></td>
                                                    <td><a  href="javascript://" onclick="excluirAluno(<%=usuario.getId()%>, '<%=usuario.getNome()%>')"><img style="width: 20px;" src="../../res/img/excluir.svg"/></a></td>
                                                </tr>
                                                <%}%>
                                            </table>
