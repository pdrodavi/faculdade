                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <%
                                                List<Professor_Turma> turmas = (List<Professor_Turma>) request.getAttribute("turmasDoProfessor");
                                            %>
                                            ...
                                            <table class="table table-hover" style="text-align: center">
                                                ...
                                                <%for (Professor_Turma turma : turmas) {%>
                                                <tr>
                                                    <td><%=turma.getSiglaTurma()%></td>
                                                    <td><%=turma.getPeriodoTurma()%></td>
                                                </tr>
                                                <%}%>
                                            </table>
