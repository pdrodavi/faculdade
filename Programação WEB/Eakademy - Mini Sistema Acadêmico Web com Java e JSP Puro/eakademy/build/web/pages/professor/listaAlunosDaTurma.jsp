        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">VISUALIZAR ALUNOS DA TURMA</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <%
                                                ArrayList<Professor_Turma> turmas_professor = (ArrayList<Professor_Turma>) request.getAttribute("turmasDoProfessor");
                                            %>

                                            <form role="form" name="visAlunosTurma" action="./visTurmasProfessor" method="post">     

                                                <div class="form-group">
                                                    <label>Turmas</label>
                                                    <select name="turma" class="form-control">
                                                        <%for(Professor_Turma turma_professor : turmas_professor){%>    
                                                            <option value=<%=turma_professor.getId()%>><%=turma_professor.getSiglaTurma()%> <%=turma_professor.getPeriodoTurma()%></option>
                                                        <%}%>    
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <input type="hidden" value="visualizarAlunosDeTurmaProfessor" name="param"/>
